...
<html><head><title>Bercy Linea Pay</title>
<style>
...
<h1>🔺 Bercy Linea Pay</h1>
<p>World's first <b>x402 + AC2</b> cross-border payment layer on Linea Mainnet.</p>
<div>
...
app.get("/api/health", async (req, res) => {
  try {
    ...
    res.json({ status: "ok", service: "Bercy Linea Pay", network: "Linea Mainnet", protocols: ["x402", "AC2"], totalCorridors: 95 });
  }
});
...
app.listen(PORT, () => console.log("Bercy Linea Pay running on port " + PORT));
